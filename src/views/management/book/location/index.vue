				...
				<el-col :span="20" v-if="bookData.length > 0 && bookId != undefined">
					...
					<div class="table-wrapper">
						<el-table :data="tableData" row-key="id" @selection-change="selectionChange" border default-expand-all>
							...
							<el-table-column prop="areaCategory.name" label="区域" width="100" align="center" />
							<el-table-column prop="typeCategory.name" label="类型" width="100" align="center" />
...
import { deleteApi, batchDeleteApi, queryApi } from "@/api/management/book/book-location"
