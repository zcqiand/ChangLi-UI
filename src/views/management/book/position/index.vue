				...
				<el-col :span="20" v-if="bookData.length > 0 && bookId != undefined">
					...
					<div class="table-wrapper">
						<el-table :data="tableData" row-key="id" @selection-change="selectionChange" border default-expand-all>
							...
							<el-table-column prop="organizationCategory.name" label="组织类别" width="100" align="center" />
...
import { deleteApi, batchDeleteApi, queryApi } from "@/api/management/book/book-position"
