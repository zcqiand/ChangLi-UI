<template>
	<div class="app-container">
				...
				<el-col :span="20" v-if="bookData.length > 0 && bookId != undefined">
					...
					<div class="toolbar-wrapper">
						<div>
							...
							<el-button type="danger" :icon="CirclePlus" @click="handleCopy">批量导入</el-button>
		...
		<copy v-if="copyVisible" ref="copyRef" :bookId="bookId" @success="handleSaveSuccess"></copy>
	</div>
</template>
...
import { deleteApi, batchDeleteApi, queryApi } from "@/api/management/book/book-location-area-category"
...
//复制
const copyRef = ref<FormInstance | null>(null)
const copyVisible = ref<boolean>(false)
const handleCopy = () => {
	copyVisible.value = true
	nextTick(() => {
		copyRef.value?.handleUpdate(undefined)
	})
}
//更多命令
