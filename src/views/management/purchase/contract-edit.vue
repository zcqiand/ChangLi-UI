	...
	<el-dialog v-model="dialogVisible" :title="currentUpdateId === undefined ? '新增' : '修改'" @close="resetForm" width="50%">
		<el-form ref="formRef" :model="formData" :rules="formRules" label-width="100px" label-position="right">
			<el-form-item prop="contractType" label="合同类型">
				<el-input v-model="formData.contractType" placeholder="请输入" />
			</el-form-item>
			...
			<el-form-item prop="contractDate" label="合同日期">
				<el-input v-model="formData.contractDate" placeholder="请输入" />
			</el-form-item>
...
const formRules: FormRules = reactive({
	contractType: [{ required: true, trigger: "blur", message: "请输入合同类型" }],
