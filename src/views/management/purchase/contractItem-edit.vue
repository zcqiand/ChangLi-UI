<template>
	...
	<el-dialog v-model="dialogVisible" :title="currentUpdateId === undefined ? '新增' : '修改'" @close="resetForm" width="50%">
		<el-form ref="formRef" :model="formData" :rules="formRules" label-width="100px" label-position="right">
			<el-form-item prop="contractId" label="合同标识">
				<el-input v-model="formData.contractId" placeholder="请输入" />
			</el-form-item>
...
import { getApi, createApi, updateApi } from "@/api/management/erp/contractItem"
...
const formRules: FormRules = reactive({
	contractId: [{ required: true, trigger: "blur", message: "请输入合同标识" }],
