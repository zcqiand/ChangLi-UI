		...
		<el-card v-loading="loading" shadow="never">
			<div class="search-wrapper">
				<el-form ref="searchFormRef" :inline="true" :model="searchData">
					<el-form-item prop="stockTitle" label="库存标题">
						<el-input v-model="searchData.stockTitle" placeholder="请输入" />
					</el-form-item>
					<el-form-item>
			...
			<div class="table-wrapper">
				<el-table :data="tableData" row-key="id" @selection-change="selectionChange" border default-expand-all>
					...
					<el-table-column prop="stockNumber" label="库存编号" width="150" align="center" />
					<el-table-column prop="stockTitle" label="库存标题">
						<template #default="scope">{{ scope.row.stockTitle }}</template>
					</el-table-column>
					<el-table-column prop="stockDate" :formatter="dateFormat" label="库存日期" width="150" align="center" />
...
import { deleteApi, batchDeleteApi, queryApi } from "@/api/management/erp/stock"
