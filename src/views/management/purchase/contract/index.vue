			...
			<div class="search-wrapper">
				<el-form ref="searchFormRef" :inline="true" :model="searchData">
					<el-form-item prop="contractTitle" label="合同标题">
						<el-input v-model="searchData.contractTitle" placeholder="请输入" />
					</el-form-item>
					<el-form-item>
			...
			<div class="table-wrapper">
				<el-table :data="tableData" row-key="id" @selection-change="selectionChange" border default-expand-all>
					...
					<el-table-column prop="contractTitle" label="合同标题">
						<template #default="scope">{{ scope.row.contractTitle }}</template>
					</el-table-column>
...
import { deleteApi, batchDeleteApi, queryApi } from "@/api/management/erp/contract"
...
const queryTableData = () => {
	...
	queryApi({
		...
		contractTitle: searchData.contractTitle || undefined
	})
		.then((res: any) => {
