		...
		<el-card v-loading="loading" shadow="never">
			<div class="search-wrapper">
				<el-form ref="searchFormRef" :inline="true" :model="searchData">
					<el-form-item prop="purchaseTitle" label="采购标题">
						<el-input v-model="searchData.purchaseTitle" placeholder="请输入" />
					</el-form-item>
					<el-form-item>
			...
			<div class="table-wrapper">
				<el-table :data="tableData" row-key="id" @selection-change="selectionChange" border default-expand-all>
					...
					<el-table-column prop="requestNumber" label="需求编号" width="150" align="center" />
					<el-table-column prop="purchaseTitle" label="采购标题">
						<template #default="scope">{{ scope.row.purchaseTitle }}</template>
					</el-table-column>
					<el-table-column prop="requestDate" :formatter="dateFormat" label="需求日期" width="150" align="center" />
...
import { deleteApi, batchDeleteApi, queryApi } from "@/api/management/erp/purchaseRequest"
...
const queryTableData = () => {
	...
	queryApi({
		...
		purchaseTitle: searchData.purchaseTitle || undefined
	})
		.then((res: any) => {
